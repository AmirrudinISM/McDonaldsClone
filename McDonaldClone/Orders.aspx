...
ORDER BY Orders.OrderDateTime DESC"></asp:SqlDataSource>
    ...
    <div id="detail" runat="server" style="display:none">
        <b>Order ID:
            <asp:Label ID="lblOrderID" runat="server" Text=""></asp:Label></b>
        <br />
        <b>Customer Name: </b>
        ...
        <br />
        <b>Total amount before rounding: </b>
        <asp:Label ID="lblTotalAmountBeforeRounding" runat="server" Text=""></asp:Label>
        <br />
        <b>Rounding: </b>
        <asp:Label ID="lblRounding" runat="server" Text=""></asp:Label>
        <br />
        <b>Grand Total: </b>
        <asp:Label ID="lblGrandTotal" runat="server" Font-Size="Large" ForeColor="#009933"></asp:Label>
    </div>
